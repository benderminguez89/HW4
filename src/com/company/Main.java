...
public class KWLinkedList<E> extends AbstractSequentialList<E> {
     ...
     * If previous is called after add, element added is returned.
     * @param obj (item being inserted)
     */
    public void add(E obj) {//Add to empty list
        if (head == null) {
            head = new Node<E>(obj);
            tail = head;
        }
            ...
            //create new node
            Node<E> newNode = new Node<E>(obj);//step 1
            ...
            nextItem.prev.next = new node;//step 2
            //link to nextItem
    ...
    }//End method add// Insert solution to programming exercise 4, section 8, chapter 2 here(above)
